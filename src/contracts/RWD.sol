...
contract RWD {
    ...
    uint256 public totalSupply = 1000000000000000000000000; // 1 million tokens (18 zeros 1000000000000000000)
    ...
    function transferFrom(address _from, address _to, uint256 _value) public returns (bool) {
        require(_value <= balanceOf[_from], 'No funds for transfer from.');
        require(_value <= allowance[_from][msg.sender], 'No funds for transfer from.');
